...
def run(playwright: Playwright) -> None:
    ...
    pasta_downloads = Path(r"C:\Users\artur.dantas\Desktop\PowerBI Automacao\Downloads\Metas\Meta 08")
    ...
    page.goto("https://app.powerbi.com/groups/me/reports/97121c89-885c-4cac-971e-c3e8a28426d2/a4e1f76d930bdd106184?experience=power-bi")
    page.wait_for_timeout(2000)
    page.get_by_role("button", name="Limpar todas as segmentações").click(timeout=60000)
    page.get_by_text("Feminicídio", exact=True).click()
    page.get_by_text("Feminicídio", exact=True).click()  
    ...
    page.goto("https://app.powerbi.com/groups/me/reports/97121c89-885c-4cac-971e-c3e8a28426d2/a4e1f76d930bdd106184?experience=power-bi")
    page.wait_for_timeout(2000)
    page.get_by_text("Violência Doméstica", exact=True).click()
    page.get_by_text("Violência Doméstica", exact=True).click()
    page.get_by_role("button", name="Limpar todas as segmentações").click(timeout=60000)
    page.get_by_role("button", name="Limpar todas as segmentações").click(timeout=60000)
    page.add_style_tag(content="html { zoom: 45% !important; }")
    ...
    download3.save_as(pasta_downloads / f"{data}_G1.xlsx")
    ...
    download4.save_as(pasta_downloads / f"{data}_G2.xlsx")
    ...
    download5.save_as(pasta_downloads / f"{data}_JE.xlsx")
