...
def run(playwright: Playwright) -> None:
    ...
    pasta_downloads = Path(
        r"C:\Users\artur.dantas\Desktop\PowerBI Automacao\Downloads\Metas\Meta 01")
    ...
    page.goto("https://app.powerbi.com/groups/me/reports/97121c89-885c-4cac-971e-c3e8a28426d2/e926e715e8787267e5a3?experience=power-bi")
    ...
    page.get_by_role("button", name="Limpar todas as segmentações").click(timeout=60000)
    page.add_style_tag(content="html { zoom: 45% !important; }")
    page.get_by_role("combobox", name="Instância").locator("i").click()
    page.get_by_role("combobox", name="Instância").click()
    page.get_by_role("combobox", name="Instância").click()
