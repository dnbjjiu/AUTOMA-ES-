...
URL = "https://app.powerbi.com/groups/me/reports/275e19f2-81fc-4617-b8e7-7b1b8e1855f1/ReportSection78e554cea0bdb9000be7"
#Arquivos de salvamento do navegador 
SESSAO = Path(r"C:\Users\artur.dantas\Desktop\PowerBI Automacao\Playwright dados\sessao.json")
#Onde vai ser salvo 
PASTA = Path(r"C:\Users\artur.dantas\Desktop\PowerBI Automacao\Downloads\Índice de Atendimento à Demanda")
#Salvar o arquivo com a data de hoje
...
with sync_playwright() as pw:
    ...
    try:
        ...
        for grau, posicao in (("G1", 2), ("G2", 3), ("JE", 4), ("TR", 5)):
            ...
            limpar.click()
            sleep(2)
            pagina.get_by_role("combobox", name="grau").locator("i").click()
            ...
            pagina.get_by_role("heading", name="IAD por Unidade Judiciária", exact=True).click()
